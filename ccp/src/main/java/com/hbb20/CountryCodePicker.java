 ...
 */
public class CountryCodePicker extends FrameLayout {
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                contentColor = a.getColor(R.styleable.CountryCodePicker_ccp_contentColor, context.getResources().getColor(android.R.color.black));
            }
            if (contentColor != 0) {
